FROM ubuntu:latest
RUN apt-get update && apt-get install -y tzdata && apt-get install -y apache2 php libapache2-mod-php net-tools iputils-ping && apt-get clean && rm -rf /var/lib/apt/lists/*
